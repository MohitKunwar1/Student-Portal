...
import NoLiveClasses from "../noLiveClasses/NoLiveClasses";

const QuickLinks = ({ liveClasses }) => {
  ...
  return (
    <div className="w-[320px] h-[238px] md:w-[400px] md:h-[700px] justify-center flex flex-col gap-2 ">
      ...
      {!liveClasses ? (
        <div
          className="w-full h-[64px] md:h-[170px] bg-[#E66DFF] rounded-lg md:rounded-3xl md:flex md:items-center md:justify-center  text-white hover:bg-white hover:text-[#E66DFF] transition-all duration-500 cursor-pointer"
