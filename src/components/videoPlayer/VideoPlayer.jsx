...
const VideoPlayer = ({ setModal }) => {
  return (
    <section className="relative h-screen w-full flex flex-col  items-center justify-center">
      <div className="absolute top-16 md:top-20 w-full  md:w-[1119px] md:h-[126px] bg-[#4749B3]  rounded-[28px] flex justify-center  cursor-pointer">
      ...
      <div className="absolute mt-7 md:mt-12 w-full md:w-[1120px] h-[630px] rounded-[28px] border-[0.5px] border-[#E66DFF] overflow-hidden cursor-pointer">
